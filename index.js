 ...
 * @param val
 */
OSS.fn.setOptions = function (key, val) {
    var the = this;
 ...
 * @private
 */
OSS.fn._pipe = function (req, callback) {
 ...
 * @param callback
 */
OSS.fn.put = function (req, options, callback) {
    var date = new Date();
    var the = this;
 ...
 * @private
 */
OSS.fn._sign = function (method, object, headers) {
 ...
 * @private
 */
OSS.fn._cleanMeta = function (options) {
    var meta = {
        user: 'ydr.me'
    };
 ...
 * @private
 */
OSS.fn._createURL = function (object) {
